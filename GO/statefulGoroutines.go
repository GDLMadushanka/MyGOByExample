/*
 This channel-based approach aligns with Go’s ideas of
 sharing memory by communicating and having each piece
...
// This will guarantee that the data is never
...
func main() {
	...
	// which is a map as in the previous example
	// but now private to the stateful goroutine.
	go func() {
